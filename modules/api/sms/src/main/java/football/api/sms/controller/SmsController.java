...
public class SmsController {
    ...
    public ResponseEntity<JsonDefault> sendSMS(@RequestBody SmsRequest data) throws CertificationException, MessageSendException {
        System.out.println("data = " + data);

        smsService.regexPhone(data.getPhone());
        smsService.distinctPhone(data.getPhone());
    ...
    public ResponseEntity<JsonDefault> sendSMSFindMember(@RequestBody SmsRequest data) throws CertificationException, MessageSendException {
        System.out.println("data = " + data);
    ...
    public ResponseEntity<JsonDefault> confirmSMS(@RequestBody SmsRequest data) throws CertificationException {
        System.out.println("data = " + data);
